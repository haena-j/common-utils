...
const roundToDecimalPlace = (value: number, decimalPlace: number = 2, asString: boolean = false): number | string => {
  if (!Number.isInteger(decimalPlace) || decimalPlace < 0 || decimalPlace > 20) {
